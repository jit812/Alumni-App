...
public class CheckedSupport extends AppCompatActivity {

    private RecyclerView recyclerView;
    private SupportadapterforUnchecked supportadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Suppots> options=
                new FirebaseRecyclerOptions.Builder<Suppots>()
                        ...
                        .build();
        supportadapter=new SupportadapterforUnchecked(options);
