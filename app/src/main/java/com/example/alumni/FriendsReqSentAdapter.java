...
public class FriendsReqSentAdapter extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    public FriendsReqSentAdapter(List<UserData> userDataList, Context context, String list_keys) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final FriendsReqSentAdapter.ViewHolderClass viewHolderClass = new FriendsReqSentAdapter.ViewHolderClass(view);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        FriendsReqSentAdapter.ViewHolderClass viewHolderClass = (FriendsReqSentAdapter.ViewHolderClass)holder;
        UserData userData = userDataList.get(position);
        ...
        ((FriendsReqSentAdapter.ViewHolderClass) holder).detailsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
