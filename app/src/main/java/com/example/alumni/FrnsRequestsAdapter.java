...
public class FrnsRequestsAdapter extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    public FrnsRequestsAdapter(List<UserData> userDataList, Context context, String list_keys) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final FrnsRequestsAdapter.ViewHolderClass viewHolderClass = new FrnsRequestsAdapter.ViewHolderClass(view);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        FrnsRequestsAdapter.ViewHolderClass viewHolderClass = (FrnsRequestsAdapter.ViewHolderClass)holder;
        UserData userData = userDataList.get(position);
        ...
        ((FrnsRequestsAdapter.ViewHolderClass) holder).detailsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
