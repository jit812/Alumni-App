...
public class SearchAdapter extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    public SearchAdapter(List<UserData> userDataList, Context context, String list_keys) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final SearchAdapter.ViewHolderClass viewHolderClass = new SearchAdapter.ViewHolderClass(view);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((SearchAdapter.ViewHolderClass) holder).detailsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
