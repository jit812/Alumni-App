...
public class FriendsRequest extends AppCompatActivity {
    RecyclerView FrnsRequestRecyclerView;
    List<UserData> userdata;
    FrnsRequestsAdapter frnsRequestsAdapter;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrnsRequestRecyclerView = findViewById(R.id.FrnsRequestRecyclerView);
        frnsRequestsAdapter = new FrnsRequestsAdapter(userdata, getApplicationContext(), list_keys);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        getWindow().setStatusBarColor(Color.WHITE);
        FrnsRequestRecyclerView.setLayoutManager(new LinearLayoutManager(FriendsRequest.this));
                ...
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    regNode.orderByKey().equalTo(list_keys).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            frnsRequestsAdapter = new FrnsRequestsAdapter(userdata, getApplicationContext(), list_keys);
                            FrnsRequestRecyclerView.setAdapter(frnsRequestsAdapter);
                        }
